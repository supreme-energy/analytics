...
class EDRScoutMotor(models.Model):
    # job = models.ForeignKey(Job, related_name="job_edr_scout_motor",
    #                         on_delete=models.PROTECT)  # 0 or many EDR_Lines to 1 Job
    creation_date = models.DateTimeField(
        auto_now_add=True)  # date generated when created
    uid = models.CharField(max_length=50)
    interval = models.ForeignKey(Interval, related_name="interval_edr_scout_motor",
                                 on_delete=models.PROTECT)  # 0 or many EDR_Lines to 1 interval
    bha = models.ForeignKey(Interval, related_name="bha_edr_scout_motor",
                            on_delete=models.PROTECT)  # 0 or many EDR_Lines to 1 interval
    formation = models.ForeignKey(Interval, related_name="formation_edr_scout_motor",
                                  on_delete=models.PROTECT)  # 0 or many EDR_Lines to 1 interval
    edr_raw = models.ForeignKey(EDRRaw, related_name="edrraw_edr_scout_motor",
                                on_delete=models.CASCADE)  # 1 EDR_Lines to 1 processed line for now, May reduce data later
    edr_processed = models.ForeignKey(EDRProcessed, related_name="edrproc_edr_scout_motor",
                                      on_delete=models.PROTECT)  # 1 EDR_Lines to 1 processed line for now, May reduce data later
    rig_time = models.DateTimeField()
    bb_GyroXmax = models.DecimalField(max_digits=3, decimal_places=1)
    bb_GyroXmin = models.DecimalField(max_digits=3, decimal_places=1)
    bb_GyroXmed = models.DecimalField(max_digits=3, decimal_places=1)
    bb_StickSlip = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ExtTemp = models.DecimalField(max_digits=5, decimal_places=1)
    bb_VbXpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbXrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbXmax = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbYpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbYrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbYmax = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbZpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbZrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_VbZmax = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShXpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShXrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShXmax = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShYpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShYrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShYmax = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShZpeak = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShZrms = models.DecimalField(max_digits=6, decimal_places=3)
    bb_ShZmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_GyroXmax = models.DecimalField(max_digits=3, decimal_places=1)
    ts_GyroXmin = models.DecimalField(max_digits=3, decimal_places=1)
    ts_GyroXmed = models.DecimalField(max_digits=3, decimal_places=1)
    ts_StickSlip = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ExtTemp = models.DecimalField(max_digits=5, decimal_places=1)
    ts_VbXpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbXrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbXmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbYpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbYrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbYmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbZpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbZrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_VbZmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShXpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShXrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShXmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShYpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShYrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShYmax = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShZpeak = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShZrms = models.DecimalField(max_digits=6, decimal_places=3)
    ts_ShZmax = models.DecimalField(max_digits=6, decimal_places=3)
