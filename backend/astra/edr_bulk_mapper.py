...
from livewits import edrdata, timeremarks, connect


def edrmapper(rig_id, data_frequency):
    url, headers, username, password, uidWell, uidWellbore, well_name, rig_name = connect(rig_id)
    ...
    if edrs_on_job.count() != 0:
        ...
        latest_time = parse_datetime("1970-05-26T05:25:18.597099-05:00")
    ...
    if comments_on_job.count() != 0:
        ...
        latest_time = parse_datetime("1970-01-01T12:00:00-05:00")
